    ...
    <div className="flex max-w-lg mx-auto my-16 overflow-hidden bg-white rounded-lg lg:space-x-8 dark:bg-gray-900 lg:max-w-5xl">
      ...
      <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <p className="mt-2 text-xl text-center text-gray-600 dark:text-gray-200">
          Join <span className="text-primary">Creative Tim TW Components</span>{" "}
          community
        </p>
        ...
        <form
          method="POST"
          action="https://www.creative-tim.com/twcomponents/register"
        >
          <input
            type="hidden"
            name="_token"
            value="G7ahXJ6MBpLiNgEHVqDHa9aVpvYfXHrB68L3oMvR"
            autoComplete="off"
          />
          <div className="mt-4">
          ...
          <div className="mt-8">
            <button
              type="submit"
              className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform rounded-md bg-primary hover:bg-primary/70 focus:outline-none focus:bg-teal-300"
            >
              Register
            </button>
          </div>
